    ...
    public function productDetail(Request $request)
    {
        ...
        if (isset($request->product_id)) {
            ...
            foreach ($productImage as $key => $value) {
                ...
                $product_image = str_replace('\\', '/', $value['product_image']);
                $productImageData[] = $baseUrl['base_url'] . $product_image;
            ...
            foreach ($randomProducts as $randomProductData) {
                ...
                $product_image = str_replace('\\', '/', $randomProductImage[0]['product_image']);
            ...
            foreach ($productViewData as $productviewdata) {
                ...
                $product_image = str_replace('\\', '/', $productViewImage[0]['product_image']);
