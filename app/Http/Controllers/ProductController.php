...
class ProductController extends Controller
{
    public function index()
    {
        ...
        foreach ($getProduct as $key => $value) {
            ...
            $getProductMasterCategory = ProductAllCategory::select('productsallcategory.mastercategory_id', 'mastercategory.master_category_name')
                ->distinct()
                ->join('mastercategory', 'mastercategory.id', '=', 'productsallcategory.mastercategory_id')
            ...
            $getProductMainCategory = ProductAllCategory::select('productsallcategory.maincategory_id', 'maincategory.main_category_name')
                ->distinct()
                ->join('maincategory', 'maincategory.id', '=', 'productsallcategory.maincategory_id')
                ->where('product_id', $value->id)->get();
            ...
            $getProductCategory = ProductAllCategory::select('productsallcategory.category_id', 'category.category_name')
                ->distinct()
                ->join('category', 'category.id', '=', 'productsallcategory.category_id')
                ->where('product_id', $value->id)->get();
            ...
            $getProductSubCategory = ProductAllCategory::select('productsallcategory.subcategory_id', 'subcategory.sub_category_name')
                ->distinct()
                ->join('subcategory', 'subcategory.id', '=', 'productsallcategory.subcategory_id')
                ->where('product_id', $value->id)->get();
    ...
    public function edit($id)
    {
        ...
        $mainCategoryData = ProductAllCategory::select('productsallcategory.mastercategory_id', 'mastermaincategory.maincategory_id', 'maincategory.*')->distinct()
            ->join('mastermaincategory', 'mastermaincategory.mastercategory_id', '=', 'productsallcategory.mastercategory_id')
            ->join('maincategory', 'maincategory.id', '=', 'mastermaincategory.maincategory_id')
            ->where('product_id', $id)
            ->where('status', 1)
            ->get()
        ...
        $categoryData = ProductAllCategory::select('productsallcategory.maincategory_id', 'maincategorycategory.category_id', 'category.*')->distinct()
            ->join('maincategorycategory', 'maincategorycategory.maincategory_id', '=', 'productsallcategory.maincategory_id')
            ->join('category', 'category.id', '=', 'maincategorycategory.category_id')
            ->where('product_id', $id)
            ->where('status', 1)
            ->get()
        ...
        $subCategoryData = ProductAllCategory::select('productsallcategory.category_id', 'categorysubcategory.subcategory_id', 'subcategory.*')->distinct()
            ->join('categorysubcategory', 'categorysubcategory.category_id', '=', 'productsallcategory.category_id')
            ->join('subcategory', 'subcategory.id', '=', 'categorysubcategory.subcategory_id')
            ->where('product_id', $id)
            ->where('status', 1)
            ->get()
